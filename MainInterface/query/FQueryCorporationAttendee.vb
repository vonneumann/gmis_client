...
Public Class FQueryCorporationAttendee
...
#Region " Windows 窗体设计器生成的代码 "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FQueryCorporationAttendee))
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn2, Me.DataGridTextBoxColumn3, Me.DataGridTextBoxColumn4, Me.DataGridTextBoxColumn5, Me.DataGridTextBoxColumn11, Me.DataGridTextBoxColumn12, Me.DataGridTextBoxColumn13, Me.DataGridTextBoxColumn14, Me.DataGridTextBoxColumn6, Me.DataGridTextBoxColumn7, Me.DataGridTextBoxColumn8, Me.DataGridTextBoxColumn9, Me.DataGridTextBoxColumn10})
        ...
        Me.DataGridTextBoxColumn11.HeaderText = "项目A角"
        Me.DataGridTextBoxColumn11.MappingName = "PMA"
        ...
        Me.DataGridTextBoxColumn12.HeaderText = "项目B角"
        Me.DataGridTextBoxColumn12.MappingName = "PMB"
        ...
        Me.DataGridTextBoxColumn13.HeaderText = "初审人员"
        Me.DataGridTextBoxColumn13.MappingName = "初审人员"
        ...
        Me.DataGridTextBoxColumn14.MappingName = "咨询人员"
        ...
        Me.DataGridTextBoxColumn10.HeaderText = "担保记录"
        Me.DataGridTextBoxColumn10.MappingName = "cgc_record_type"
        ...
        Me.Name = "FQueryCorporationAttendee"
...
#End Region
	...
	Public Overloads Sub Refresh(ByVal Condition As String)
		Try
			...
			Dim rsResult As DataSet = gWs.GetQueryCorporationAttendee(projectNo, corporationNo, corporationName, phase, serviceType, dtpFromDate.Value, dtpToDate.Value)

			grdTable.SetDataBinding(rsResult, "Table")
            Me.Text = "正式受理企业一览表(" + rsResult.Tables("Table").Rows.Count.ToString + ")"
		Finally
	...
	Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
		...
		Try
			...
			If Not grdTable.DataSource Is Nothing Then
				...
				CType(dataSource, DataTable).TableName = "TQueryCorporationAttendee"
				dataSource = grdTable.DataSource
			End If

			reportViewerForm.ShowDialog(Application.StartupPath + "\Reports\QueryCorporationAttendee.rpt", dataSource, "正式受理企业一览表", Me)
		Finally
