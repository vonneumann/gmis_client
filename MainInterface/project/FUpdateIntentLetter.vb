...
Public Class FUpdateIntentLetter
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FUpdateIntentLetter))
        ...
        Me.btnExit.Location = New System.Drawing.Point(344, 408)
        ...
        Me.btnQuery.Location = New System.Drawing.Point(173, 409)
        ...
        Me.btnEntery.Location = New System.Drawing.Point(260, 409)
...
#End Region
    ...
    Private Sub btnEntery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEntery.Click
        ...
        Dim dsAttendee As DataSet

        '2005-09-16 yjf add 挂起当前正在进行的任务
        Dim strSql As String
        strSql = "{project_code='" & tmpProjectID & "'" ' AND isnull(task_status,'')='P'"
        dsAttendee = gWs.GetProjectTaskAttendeeInfo("{project_code='" & tmpProjectID & "' AND isnull(task_status,'')='P'}")
        If dsAttendee.Tables(0).Rows.Count > 0 Then
            Dim i As Integer

            For i = 0 To dsAttendee.Tables(0).Rows.Count - 1
                dsAttendee.Tables(0).Rows(0)("task_status") = "C"
            Next

            Dim result As String = gWs.UpdateProjectTaskAttendee(dsAttendee.GetChanges)
           
        End If

        dsAttendee = gWs.GetProjectTaskAttendeeInfo("{project_code='" & tmpProjectID & "' AND task_id='ApplyLetterIntent'}")
        If dsAttendee.Tables(0).Rows.Count > 0 Then
            dsAttendee.Tables(0).Rows(0)("task_status") = "P"

            Dim result As String = gWs.UpdateProjectTaskAttendee(dsAttendee.GetChanges)
            If result = "1" Then
                SWDialogBox.MessageBox.Show("操作执行成功", "系统提示", "", SWDialogBox.MessageBoxButton.OK, SWDialogBox.MessageBoxIcon.Information)
                RaiseEvent refreshTaskCommit()
            Else
                SWDialogBox.MessageBox.Show("*999", "操作失败", result, "")
            End If
        End If
        dsAttendee.Dispose()
