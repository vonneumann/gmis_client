...
Public Class FAffirmReturnSecurityFee
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FAffirmReturnSecurityFee))
        ...
        Me.Controls.Add(Me.txtSecurityFee)
        Me.Controls.Add(Me.txtCorName)
        Me.Controls.Add(Me.txtProjectCode)
        Me.Controls.Add(Me.Label15)
        Me.Controls.Add(Me.txtSecurityRate)
        ...
        Me.Name = "FAffirmReturnSecurityFee"
        Me.Text = "确认释放保证金"
...
#End Region
    ...
    '确认收取保证金
    Private Sub FAffirmReturnSecurityFee_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            dsAccount = gWs.GetProjectAccountDetailInfo("{project_code LIKE '" & ProjectCode & "' AND item_type='34' AND item_code='009' AND NOT income IS NULL ORDER BY serial_num DESC}")
            Dim incomeSecurityFee As Double
            Dim i As Integer
            For i = 0 To dsAccount.Tables(0).Rows.Count - 1
                incomeSecurityFee = incomeSecurityFee + dsAccount.Tables(0).Rows(i).Item("income")
            Next
            bmAccount = BindingContext(dsAccount, "project_account_detail")
            'txtSecurityFee.DataBindings.Add("Text", dsAccount, "project_account_detail.income")
            txtSecurityFee.Text = incomeSecurityFee.ToString("n")
    ...
    Private Sub btnCommit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCommit.Click
        ...
        If dsAccount.Tables(0).Rows.Count > 0 Then
            dsAccount.Tables(0).Rows(0)("income") = IIf(txtSecurityFee.Text <> String.Empty, txtSecurityFee.Text, DBNull.Value)
        ElseIf CDbl(txtSecurityFee.Text) > 0 Then
            ...
            With dr
                ...
                .Item("item_type") = "34"
                .Item("item_code") = "009"
                .Item("income") = IIf(txtSecurityFee.Text <> String.Empty, txtSecurityFee.Text, DBNull.Value)
