Public Class FCreditAppraiseQuantity
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    Public Sub New()
        ...
        csIndexQuotiety.TextBox.MaxLength = 8
        csIndexUnit.TextBox.MaxLength = 10
        csIndexRemark.TextBox.MaxLength = 50
        Me.csStandardSerialID.TextBox.MaxLength = 3
        Me.csStandardScore.TextBox.MaxLength = 6
        Me.csStandardLower.TextBox.MaxLength = 20
        Me.csStandardUpper.TextBox.MaxLength = 20
    End Sub
    ...
    Friend WithEvents tsTCreditQuantityIndex As System.Windows.Forms.DataGridTableStyle
    Friend WithEvents tsTCreditQuantityStandard As System.Windows.Forms.DataGridTableStyle
	...
	Friend WithEvents csStandardLower As System.Windows.Forms.DataGridTextBoxColumn
	Friend WithEvents csStandardUpper As System.Windows.Forms.DataGridTextBoxColumn
	Friend WithEvents csIndexQuotiety As System.Windows.Forms.DataGridTextBoxColumn
	Friend WithEvents csIndexUnit As System.Windows.Forms.DataGridTextBoxColumn
	Friend WithEvents csIndexCompare As System.Windows.Forms.DataGridBoolColumn
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FCreditAppraiseQuantity))
        ...
        Me.tsTCreditQuantityIndex = New System.Windows.Forms.DataGridTableStyle()
        ...
        Me.csIndexQuotiety = New System.Windows.Forms.DataGridTextBoxColumn()
        Me.csIndexUnit = New System.Windows.Forms.DataGridTextBoxColumn()
        Me.csIndexFlag = New System.Windows.Forms.DataGridBoolColumn()
        Me.csIndexCompare = New System.Windows.Forms.DataGridBoolColumn()
        Me.csIndexRemark = New System.Windows.Forms.DataGridTextBoxColumn()
        Me.tsTCreditQuantityStandard = New System.Windows.Forms.DataGridTableStyle()
        ...
        Me.csStandardLower = New System.Windows.Forms.DataGridTextBoxColumn()
        Me.csStandardUpper = New System.Windows.Forms.DataGridTextBoxColumn()
        ...
        Me.txtRemark.Text = ""
        Me.grdMaster.TableStyles.AddRange(New System.Windows.Forms.DataGridTableStyle() {Me.tsTCreditQuantityIndex})
        '
        'tsTCreditQuantityIndex
        '
        Me.tsTCreditQuantityIndex.DataGrid = Me.grdMaster
        Me.tsTCreditQuantityIndex.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.csIndexSystemID, Me.csIndexIndexType, Me.csIndexOrderID, Me.csIndexIndexID, Me.csIndexIndexName, Me.csIndexFullMark, Me.csIndexQuotiety, Me.csIndexUnit, Me.csIndexFlag, Me.csIndexCompare, Me.csIndexRemark})
        Me.tsTCreditQuantityIndex.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.tsTCreditQuantityIndex.MappingName = "TCreditQuantityIndex"
        '
        'csIndexSystemID
        '
        ...
        'csIndexQuotiety
        '
        Me.csIndexQuotiety.Alignment = System.Windows.Forms.HorizontalAlignment.Right
        Me.csIndexQuotiety.Format = "0.00"
        Me.csIndexQuotiety.FormatInfo = Nothing
        Me.csIndexQuotiety.HeaderText = "权  重"
        Me.csIndexQuotiety.MappingName = "quotiety"
        Me.csIndexQuotiety.Width = 60
        '
        'csIndexUnit
        '
        Me.csIndexUnit.Alignment = System.Windows.Forms.HorizontalAlignment.Center
        Me.csIndexUnit.Format = ""
        Me.csIndexUnit.FormatInfo = Nothing
        Me.csIndexUnit.HeaderText = "单  位"
        Me.csIndexUnit.MappingName = "unit"
        Me.csIndexUnit.Width = 60
        '
        'csIndexFlag
        '
        Me.csIndexFlag.AllowNull = False
        Me.csIndexFlag.Alignment = System.Windows.Forms.HorizontalAlignment.Center
        Me.csIndexFlag.FalseValue = False
        Me.csIndexFlag.HeaderText = "是否评分"
        ...
        'csIndexCompare
        '
        Me.csIndexCompare.AllowNull = False
        Me.csIndexCompare.FalseValue = False
        Me.csIndexCompare.HeaderText = "比较方式"
        Me.csIndexCompare.MappingName = "compare"
        Me.csIndexCompare.NullValue = CType(resources.GetObject("csIndexCompare.NullValue"), System.DBNull)
        Me.csIndexCompare.TrueValue = True
        Me.csIndexCompare.Width = 60
        '
        'csIndexRemark
        '
        ...
        'grdDetail
        '
        Me.grdDetail.TableStyles.AddRange(New System.Windows.Forms.DataGridTableStyle() {Me.tsTCreditQuantityStandard})
        '
        'tsTCreditQuantityStandard
        '
        Me.tsTCreditQuantityStandard.DataGrid = Me.grdDetail
        Me.tsTCreditQuantityStandard.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.csStandardSystemID, Me.csStandardIndexType, Me.csStandardIndexID, Me.csStandardSerialID, Me.csStandardScore, Me.csStandardLower, Me.csStandardUpper})
        Me.tsTCreditQuantityStandard.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.tsTCreditQuantityStandard.MappingName = "TCreditQuantityStandard"
        '
        'csStandardSystemID
        '
        ...
        'csStandardLower
        '
        Me.csStandardLower.Alignment = System.Windows.Forms.HorizontalAlignment.Right
        Me.csStandardLower.Format = ""
        Me.csStandardLower.FormatInfo = Nothing
        Me.csStandardLower.HeaderText = "下  限"
        Me.csStandardLower.MappingName = "lower_bound"
        Me.csStandardLower.Width = 80
        '
        'csStandardUpper
        '
        Me.csStandardUpper.Alignment = System.Windows.Forms.HorizontalAlignment.Right
        Me.csStandardUpper.Format = ""
        Me.csStandardUpper.FormatInfo = Nothing
        Me.csStandardUpper.HeaderText = "上  限"
        Me.csStandardUpper.MappingName = "upper_bound"
        Me.csStandardUpper.Width = 80
        '
        'FCreditAppraiseQuantity
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
        Me.ClientSize = New System.Drawing.Size(632, 413)
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.btnExit, Me.btnDelete, Me.btnRefresh, Me.btnUpdate, Me.grdDetail, Me.splHorizontal, Me.grdMaster, Me.txtRemark, Me.lblDate, Me.lblUsed, Me.lblSystemID, Me.cboSystemID})
        Me.DockPadding.Bottom = 40
        Me.DockPadding.Left = 8
        Me.DockPadding.Right = 8
        Me.DockPadding.Top = 40
        Me.Icon = CType(resources.GetObject("$this.Icon"), System.Drawing.Icon)
        Me.Name = "FCreditAppraiseQuantity"
        Me.Text = "定量分析指标设置"
...
#End Region
    ...
    Public Overloads Function RefreshData(ByVal SystemID As Integer) As Boolean
        Try
            ...
            grdMaster.SetDataBinding(gWs.FetchCreditQuantityIndex(SystemID, "%", "%"), "TCreditQuantityIndex")
            grdDetail.SetDataBinding(gWs.FetchCreditQuantityStandard("{system_id=" + SystemID.ToString() + "}"), "TCreditQuantityStandard")
    ...
    Public Overrides Function UpdateData() As Boolean
        Try
            ...
            If (Not dsMaster Is Nothing) AndAlso dsMaster.HasChanges() Then
                result = gWs.UpdateCreditQuantityIndex(dsMaster.GetChanges())
            End If
            If (Not dsDetail Is Nothing) AndAlso dsDetail.HasChanges() Then
                result = gWs.UpdateCreditQuantityStandard(dsDetail.GetChanges())
            End If
    ...
    Private Sub FCreditAppraiseQuantity_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim dsResult As DataSet = gWs.FetchCreditAppraiseSystem("%")
        cboSystemID.DataSource = dsResult.Tables(0)
        cboSystemID.DisplayMember = "system_id"
        cboSystemID.ValueMember = "system_id"

        dsResult = gWs.FetchCreditIndexType(1)
    ...
    Protected Overrides Function DeleteDetailConfirm() As DialogResult
        ...
        Return SWDialogBox.MessageBox.Show("?1004", "［" + CType(cm.Current, DataRowView)("serial_num").ToString() + "］")
    End Function
End Class