'作者：罗庆锋；日期2003-04-05
Public Class frmProjectReturnPlanExp
    Inherits frmBasic
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmProjectReturnPlanExp))
        ...
        'gpbxDG
        '
        Me.gpbxDG.Anchor = CType((((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                    Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.gpbxDG.Controls.Add(Me.dgShow)
        ...
        'gpbxPlan
        '
        Me.gpbxPlan.Anchor = CType(((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.gpbxPlan.Controls.Add(Me.txtEachReturn)
        Me.gpbxPlan.Controls.Add(Me.Label12)
        Me.gpbxPlan.Controls.Add(Me.dtpFirstDate)
        Me.gpbxPlan.Controls.Add(Me.Label14)
        Me.gpbxPlan.Controls.Add(Me.txtAbstract)
        Me.gpbxPlan.Controls.Add(Me.Label1)
        Me.gpbxPlan.Controls.Add(Me.txtBalance)
        Me.gpbxPlan.Controls.Add(Me.Label13)
        ...
        Me.GroupBox1.Controls.Add(Me.txtShowMoney)
        Me.GroupBox1.Controls.Add(Me.Label3)
        Me.GroupBox1.Controls.Add(Me.Label16)
        Me.GroupBox1.Controls.Add(Me.Label15)
        Me.GroupBox1.Controls.Add(Me.txtLoanSum)
        Me.GroupBox1.Controls.Add(Me.txtRefundType)
...
#End Region
    ...
    Private Sub GetDataSourceForRefundPlan()
        ...
        dsConferenceTrial = gWs.GetProjectExpandDateInfo("{project_code = '" & ProjectCode & "'}")
        If dsConferenceTrial.Tables(0).Rows.Count <> 0 Then
            '绑定贷款金额,还款方式,担保期限,每次还款额
            txtLoanSum.DataBindings.Add(New Binding("Text", dsConferenceTrial, "project_expand_date.exp_amount"))
            txtRefundType.DataBindings.Add(New Binding("Text", dsConferenceTrial, "project_expand_date.exp_refund_type"))
            RefundType = gWs.GetRefundType("{refund_type='" & txtRefundType.Text & "'}").Tables(0).Rows(0)("refund_type_code").ToString()
            txtShowMoney.DataBindings.Add(New Binding("Text", dsConferenceTrial, "project_expand_date.exp_refund_amount"))
            If txtShowMoney.Text <> String.Empty Then
                OriginalMoney = txtShowMoney.Text
            End If
            txtMonth.DataBindings.Add(New Binding("Text", dsConferenceTrial, "project_expand_date.exp_term"))
            ...
            EndDate = dsConferenceTrial.Tables(0).Rows(0).Item("exp_end_time")
            txtEndDate.Text = String.Format("{0:yyyy年M月d日}", EndDate)
        End If
    End Sub

    Private Sub frmProjectReturnPlanExp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnCommit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCommit.Click
        ...
        If strSuccess = "1" Then
            ...
            RemoveHandler MyBase.Closing, AddressOf frmProjectReturnPlanExp_Closing
            Close()
        Else
    ...
    Private Function ConfirmClose(ByVal sender As Object, ByVal e As EventArgs) As Boolean
        ...
        Return True
    End Function
    Private Sub frmProjectReturnPlanExp_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        e.Cancel = Not ConfirmClose(sender, e)
    End Sub

    Private Sub frmProjectReturnPlanExp_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
