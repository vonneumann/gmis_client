...
Public Class FQueryStatisticsGECraft
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        '
        'FQueryStatisticsGECraft
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
        Me.ClientSize = New System.Drawing.Size(712, 493)
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.btnExport, Me.btnClear, Me.grdTable, Me.btnPrint, Me.btnExit, Me.btnRefresh, Me.chkVisible, Me.grpCondition})
        Me.Name = "FQueryStatisticsGECraft"
        Me.Text = "担保企业技术状况统计表"
...
#End Region
    ...
    Private Sub FQueryStatisticsGECraft_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ReportFile = Application.StartupPath & "\Reports\QueryStatisticsGECraft.rpt"
        ReportTitle = "担保企业技术状况统计表"
    ...
    Protected Overloads Overrides Sub Refresh(ByVal Condition As String)
        ...
        Dim ds As DataSet = gWs.FQueryStatisticsGECraft(StartYear, EndYearMonth)
        ds.Tables(0).TableName = "TQueryStatisticsGECraft"
    ...
    Private Sub AddTableStyle()
        ...
        dgts.MappingName = "TQueryStatisticsGECraft"
        dgts.AllowSorting = False
        Dim col1 As DataGridTextBoxColumn = New DataGridTextBoxColumn()
        col1.MappingName = "TypeName"
        col1.HeaderText = "企业类别"
        col1.Width = 220
