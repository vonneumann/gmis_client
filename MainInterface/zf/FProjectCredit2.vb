...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.tabTable.Controls.AddRange(New System.Windows.Forms.Control() {Me.tabCreditQuantity, Me.tabCreditQuality, Me.tabCredit})
        ...
        'tabCreditQuantity
        '
        Me.tabCreditQuantity.Controls.AddRange(New System.Windows.Forms.Control() {Me.txtCreditTotal, Me.txtQualityTotal, Me.txtQuantityTotal, Me.lblCreditTotal, Me.lblQualityTotal, Me.lblQuantityTotal, Me.grdQuantity})
        ...
        'txtCreditTotal
        '
        Me.txtCreditTotal.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Right)
        ...
        'txtQualityTotal
        '
        Me.txtQualityTotal.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left)
        ...
        'txtQuantityTotal
        '
        Me.txtQuantityTotal.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left)
        ...
        'lblCreditTotal
        '
        Me.lblCreditTotal.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Right)
        ...
        'lblQualityTotal
        '
        Me.lblQualityTotal.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left)
        ...
        'lblQuantityTotal
        '
        Me.lblQuantityTotal.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left)
        ...
        'grdQuantity
        '
        Me.grdQuantity.Anchor = (((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                    Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right)
        ...
        'tabCreditQuality
        '
        Me.tabCreditQuality.Controls.AddRange(New System.Windows.Forms.Control() {Me.txtQuality, Me.cboQuality, Me.lblQuality, Me.grdQuality})
        ...
        'txtQuality
        '
        Me.txtQuality.Anchor = ((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right)
        ...
        'cboQuality
        '
        Me.cboQuality.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left)
        ...
        'lblQuality
        '
        Me.lblQuality.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left)
        Me.lblQuality.AutoSize = True
        Me.lblQuality.Location = New System.Drawing.Point(0, 224)
        Me.lblQuality.Name = "lblQuality"
        Me.lblQuality.Size = New System.Drawing.Size(45, 15)
        ...
        Me.grdQuality.Anchor = (((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                    Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right)
        ...
        Me.tsQuality.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.csProjectNo, Me.csPhase, Me.csIndexName, Me.csIndexValue, Me.csScore, Me.csRemark})
        ...
        'tabCredit
        '
        Me.tabCredit.Controls.AddRange(New System.Windows.Forms.Control() {Me.grdCredit})
        ...
        Me.lblTitle.Size = New System.Drawing.Size(144, 15)
        ...
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.txtProjectNo, Me.cboMonth, Me.cboLastMonth, Me.Label1, Me.lblPhase, Me.lblTitle, Me.lblProjectNo, Me.lblMonth, Me.cboCorporationNo, Me.cboPhase, Me.btnExit, Me.btnCreate, Me.btnRefresh, Me.tabTable})
...
#End Region
    ...
    Private Sub CreateCreditQuality()
        Dim dsResult As DataSet = gWs.FetchProjectCreditQuality( _
           "{dbo.project_credit_quality_score.project_code LIKE '" + txtProjectNo.Text.Trim() + "' AND " + _
           ...
           " dbo.project_credit_quality_score.system_id = " + tmpSystemID.ToString + _
           " dbo.project_credit_quality_score.[month]='" + cboMonth.Text + "'}")

        '如果返回的表没有记录则创建它
        If dsResult.Tables(0).Rows.Count = 0 Then
            '创建定性分析表
            gWs.CreateProjectCreditQuality(txtProjectNo.Text.Trim(), cboCorporationNo.SelectedValue, cboPhase.Text)

            '重新获取定性分析的数据
            dsResult = gWs.FetchProjectCreditQuality( _
           "{dbo.project_credit_quality_score.project_code LIKE '" + txtProjectNo.Text.Trim() + "' AND " + _
           " dbo.project_credit_quality_score.corporation_code LIKE '" + cboCorporationNo.SelectedValue + "' AND " + _
           " dbo.project_credit_quality_score.phase LIKE '" + cboPhase.Text + "' AND " + _
           " dbo.project_credit_quality_score.system_id = " + tmpSystemID.ToString + _
