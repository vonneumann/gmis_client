...
Public Class FChargeBackFeeTool
...
#End Region
    ...
    Private Sub FUpdateMeetRecord_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If dsTempProject.Tables(0).Rows.Count = 0 Then
            MsgBox("无项目列表!", MsgBoxStyle.Information, "项目退费")
    ...
    Private Sub btnEntery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEntery.Click
        ...
        Dim objFchargeBackFee As FChargeBackFee = New FChargeBackFee()
        'AddHandler fChargeBackFee.TaskCommit, AddressOf refreshTaskCommitSub
        objFchargeBackFee.OpenApplyTool(tmpProjectID, strCorpName, getWorkFlowID(), getTaskID(), Me, UserName)
