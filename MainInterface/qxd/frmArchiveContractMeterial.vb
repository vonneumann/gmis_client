...
Public Class frmArchiveContractMeterial
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmArchiveContractMeterial))
        ...
        Me.Name = "frmArchiveContractMeterial"
...
#End Region
    ...
    'Load()
    Private Sub frmArchiveContractMeterial_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Function getProjectDocument() As DataSet
        ...
        If gWs Is Nothing Then
            Exit Function
        End If
        strSql = "{project_code='" & strProjectCode & "' and (item_type='43') and check_person is not null order by item_type desc}"
        Try
