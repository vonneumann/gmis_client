Public Class frmChattelContract
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    Private dsProjectContractChattel As DataSet
    ...
    Public Sub New(ByVal ProjectCode As String, ByVal ContractName As String, ByVal ProjectContractEstateList As DataSet)
        ...
        dsProjectContractChattel = ProjectContractEstateList
    End Sub
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmChattelContract))
        ...
        Me.DataGridTableStyle1.MappingName = "project_contract_chattel_element"
        '
        'DataGridTextBoxColumn1
        '
        Me.DataGridTextBoxColumn1.Format = ""
        Me.DataGridTextBoxColumn1.FormatInfo = Nothing
        Me.DataGridTextBoxColumn1.HeaderText = "名称"
        ...
        Me.DataGridTextBoxColumn2.HeaderText = "数量"
        ...
        Me.DataGridTextBoxColumn3.HeaderText = "原值"
        Me.DataGridTextBoxColumn3.MappingName = "source_amount"
        ...
        Me.DataGridTextBoxColumn4.HeaderText = "编号(型号)"
        Me.DataGridTextBoxColumn4.MappingName = "specification"
        ...
        Me.DataGridTextBoxColumn5.HeaderText = "发票号码"
        Me.DataGridTextBoxColumn5.MappingName = "invoice_num"
...
#End Region
    ...
    Private Sub frmChattelContract_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '填充设备清单
        If dsProjectContractChattel.Tables(0).Rows.Count = 0 Then

            '获取评审通过的设备
            strSql = "select project_code,serial_num,original_value from opposite_guarantee where project_code='" & strProjectCode & "' and guaranty_type='23' and status='评审通过'"
            ...
            If dsGuarantee.Tables(0).Rows.Count <> 0 Then
                ...
                strSql = "SELECT dbo.opposite_guarantee.project_code, dbo.opposite_guarantee.serial_num," & _
                         ...
                         " (dbo.opposite_guarantee.guaranty_type = '23') AND  " & _
                         " (dbo.opposite_guarantee_detail.item_type = '23') AND  " & _
                         " (dbo.opposite_guarantee_detail.item_code IN ('001', '002', '003','010'))"
                ...
                For i = 0 To dsGuarantee.Tables(0).Rows.Count - 1
                    ...
                    dr = dsProjectContractChattel.Tables(0).NewRow
                    With dr
                        dr.Item("project_code") = strProjectCode
                        dr.Item("num") = j
                        dr.Item("contract_name") = Trim(strContractName)
                        dr.Item("source_amount") = dsGuarantee.Tables(0).Rows(i).Item("original_value")

                        For Each drTemp In dsGuaranteeDetail.Tables(0).Select("serial_num='" & strSerialNum & "'")

                            Select Case drTemp.Item("item_code")
                                Case "001"
                                    dr.Item("name") = drTemp.Item("item_value")
                                Case "002"
                                    dr.Item("specification") = drTemp.Item("item_value")
                                Case "003"
                                    dr.Item("amount") = drTemp.Item("item_value")
                                Case "010"
                                    dr.Item("invoice_num") = drTemp.Item("item_value")
                            End Select
                        Next
                    End With
                    dsProjectContractChattel.Tables(0).Rows.Add(dr)
                Next
            End If
        End If

        DataGrid1.DataSource = dsProjectContractChattel.Tables(0)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Dim strResult As String = gWs.UpdateProjectContractChattelElement(dsProjectContractChattel)
        If (strResult = "1") Then
            SWDialogBox.MessageBox.Show("$SaveSucceed")
            dsProjectContractChattel.AcceptChanges()
        Else
    ...
    Private Sub btnClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClear.Click
        Dim i As Integer
        For i = 0 To dsProjectContractChattel.Tables(0).Rows.Count - 1
            dsProjectContractChattel.Tables(0).Rows(i).Delete()
        Next
        DataGrid1.DataSource = dsProjectContractChattel.Tables(0)
        setDgAttribute(DataGrid1, Me)
        'setDgDeleteAttribute(DataGrid1, Me)
