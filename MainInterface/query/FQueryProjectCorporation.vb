...
Public Class FQueryProjectCorporation
...
#Region " Windows 窗体设计器生成的代码 "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FQueryProjectCorporation))
        ...
        Me.grpCondition.Controls.AddRange(New System.Windows.Forms.Control() {Me.cboDistrictName, Me.lblToDate, Me.dtpToDate, Me.lblFromDate, Me.dtpFromDate, Me.txtProjectNo, Me.lblProjectNo, Me.lblDistrictName, Me.txtPhase, Me.lblPhase, Me.txtCorporationName, Me.lblCorporationName, Me.txtCorporationNo, Me.lblCorporationNo})
        ...
        Me.cboDistrictName.TabIndex = 15
        '
        'lblToDate
        '
        ...
        'txtPhase
        '
        Me.txtPhase.Font = New System.Drawing.Font("宋体", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.txtPhase.Location = New System.Drawing.Point(64, 40)
        Me.txtPhase.Name = "txtPhase"
        Me.txtPhase.Size = New System.Drawing.Size(120, 21)
        Me.txtPhase.TabIndex = 6
        Me.txtPhase.Text = ""
        '
        'lblPhase
        '
        ...
        Me.DataGridTextBoxColumn9.HeaderText = "所属地区"
        Me.DataGridTextBoxColumn9.MappingName = "district_name"
        ...
        Me.DataGridTextBoxColumn10.HeaderText = "所属行业"
        Me.DataGridTextBoxColumn10.MappingName = "industry_type"
        ...
        Me.Name = "FQueryProjectCorporation"
...
#End Region
	...
	Private Sub TextEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCorporationNo.Enter, txtCorporationName.Enter, txtProjectNo.Enter, txtPhase.Enter
	...
	Public Overloads Sub Refresh(ByVal Condition As String)
		Try
			...
			Dim projectNo, corporationNo, corporationName, districtName As String

			Me.GetCondition(projectNo, corporationNo, corporationName, districtName)

			Dim rsResult As DataSet = gWs.GetQueryProjectInfo(projectNo, corporationNo, corporationName, districtName, IIf(txtPhase.Text.Trim() = "", "%", txtPhase.Text), dtpFromDate.Value, dtpToDate.Value)

			grdTable.SetDataBinding(rsResult, "Table")
            Me.Text = "申请企业一览表(" + rsResult.Tables("Table").Rows.Count.ToString + ")"
		Finally
			Me.Cursor = Cursors.Default
		End Try
	End Sub

	Private Function GetCondition(ByRef projectNo As String, ByRef corporationNo As String, ByRef corporationName As String, ByRef districtName As String) As String
		...
		districtName = IIf(cboDistrictName.Text.Trim() = "", "%", cboDistrictName.Text)
	End Function
	...
	Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
		...
		Try
			...
			If Not grdTable.DataSource Is Nothing Then
				...
				CType(dataSource, DataTable).TableName = "TQueryProject"
				dataSource = grdTable.DataSource
			End If

			reportViewerForm.ShowDialog(Application.StartupPath + "\Reports\QueryProject.rpt", dataSource, "申请企业一览表", Me)
		Finally
