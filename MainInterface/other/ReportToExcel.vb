...
Public Class ReportToExcel
    ...
    Public Shared Sub ToExcel(ByVal dg As DataGrid, ByVal filePath As String, ByVal fileName As String, Optional ByVal array As ArrayList = Nothing)
        ...
        If System.IO.Directory.Exists(filePath) = False Then System.IO.Directory.CreateDirectory(filePath)
        If Not InStr(Application.StartupPath, filePath) > 0 Then '传入的为相对路径
            filePath = Application.StartupPath & "\Excel\" & filePath
        End If
