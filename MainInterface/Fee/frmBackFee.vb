...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmBackFee))
        ...
        'lblFeeType
        '
        Me.lblFeeType.Location = New System.Drawing.Point(420, 16)
        '
        'dtpDate
        '
        ...
        Me.cmbxType.Location = New System.Drawing.Point(476, 13)
        Me.cmbxType.Size = New System.Drawing.Size(92, 20)
        '
        'txtIncome
        '
        ...
        Me.txtBalance.Location = New System.Drawing.Point(96, 35)
        ...
        Me.txtHaveCharged.Location = New System.Drawing.Point(274, 38)
...
#End Region
    ...
    Private Sub cmbxType_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbxType.SelectedIndexChanged
        ...
        item_code = CType(cmbxType.SelectedItem, DataRowView).Item("item_code").ToString()
        IsReturnReviewFee = False
        IsReturnGuaranteeFee = False
        IsReturnEvaluateFee = False
        IsReturnFinancingConsultingFee = False

        If item_code = "001" Then
            Me.IsReturnReviewFee = True
        ElseIf item_code = "002" Then
            Me.IsReturnGuaranteeFee = True
        ElseIf item_code = "003" Then
            Me.IsReturnEvaluateFee = True
        ElseIf item_code = "004" Then
            Me.IsReturnFinancingConsultingFee = True
        End If
        ...
        'CaculateLessMoney()
        'txtIncome.Text = LessMoney.ToString("n")
        'Me.txtBalance.Text = LessMoney.ToString("n")
        Me.txtSummary.Text = Me.TypeDescription()

    End Sub

    Private Sub CaculateLessMoney()
        Dim returnSum As Double = 0
        Dim incomeSum As Double = 0
        Dim dr As DataRow
        Dim i, count As Int32
