...
Public Class FQueryEvaluaterTask
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FQueryEvaluaterTask))
        ...
        Me.btnExit.Location = New System.Drawing.Point(300, 408)
        ...
        Me.DataGridTextBoxColumn5.HeaderText = "预约评估时间"
        Me.DataGridTextBoxColumn5.MappingName = "evaluate_date"
        ...
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.GroupBox2, Me.GroupBox1, Me.btnExit})
        Me.Name = "FQueryEvaluaterTask"
        Me.Text = "查询当前工作任务"
...
#End Region
    ...
    Private Sub FQueryEvaluaterTask_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        isLoad = True
    ...
    Private Sub btnQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnQuery.Click
        ...
        strSql = "select a.*,b.task_name,b.start_time from project_task_attendee a left join " & _
        ...
        'evaluate_date,affirm_evaluate_date
        If dt.Columns.Item("evaluate_date") Is Nothing Then
            dt.Columns.Add("evaluate_date", GetType(String))
            dt.Columns.Add("affirm_evaluate_date", GetType(String))
        End If
        count = dt.Rows.Count
        If count > 0 Then
            For i = 0 To count - 1
                strProjectCode = dt.Rows(i).Item("project_code")
                strSql = "{project_code='" & strProjectCode & "' and evaluate_date is not null}"

                dsOpp = gWs.GetGuarantyInfo(strSql, "")
                If Not dsOpp Is Nothing Then
                    If dsOpp.Tables("opposite_guarantee").Rows.Count > 0 Then
                        If Not dsOpp.Tables("opposite_guarantee").Rows(0).Item("evaluate_date") Is System.DBNull.Value Then
                            dt.Rows(i).Item("evaluate_date") = dsOpp.Tables("opposite_guarantee").Rows(0).Item("evaluate_date")
                        End If
                        If Not dsOpp.Tables("opposite_guarantee").Rows(0).Item("affirm_evaluate_date") Is System.DBNull.Value Then
                            dt.Rows(i).Item("affirm_evaluate_date") = dsOpp.Tables("opposite_guarantee").Rows(0).Item("affirm_evaluate_date")
                        End If
                    End If
                End If
            Next
