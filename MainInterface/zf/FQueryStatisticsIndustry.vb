Public Class FQueryStatisticsIndustry
...
#Region " Windows 窗体设计器生成的代码 "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FQueryStatisticsIndustry))
		...
		Me.DataGridTextBoxColumn1.HeaderText = "行业名称"
		Me.DataGridTextBoxColumn1.MappingName = "IndustryName"
		...
		Me.KeyPreview = True
		Me.Name = "FQueryStatisticsIndustry"
		Me.Text = "担保业务行业统计"
...
#End Region
	...
	Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
		...
		Try
			...
			If Not grdTable.DataSource Is Nothing Then
				...
				CType(dataSource, DataTable).TableName = "TQueryStatisticsIndustry"
				dataSource = grdTable.DataSource
			End If

			reportViewerForm.ShowDialog(Application.StartupPath + "\Reports\QueryStatisticsIndustry.rpt", dataSource, "担保业务行业统计", Me)
		Finally
	...
	Public Overloads Sub Refresh()
		Try
			...
			Dim rsResult As DataSet = gWs.GetQueryStatisticsIndustryInfo(dtpDateFrom.Value, dtpDateTo.Value)

			grdTable.SetDataBinding(rsResult, "Table")
			Me.Text = "担保业务行业统计(" + rsResult.Tables("Table").Rows.Count.ToString + ")"
		Finally
			Me.Cursor = Cursors.Default
		End Try
	End Sub
	...
	Private Sub FQueryStatisticsIndustry_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
