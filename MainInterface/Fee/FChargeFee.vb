...
#End Region
    ...
    Private ItemCode() As String = {"001", "002", "004", "009"} '这里必须保证item_code小的在前
    Private balance() As Double = {0, 0, 0, 0} '差额
    Private payout() As Double = {0, 0, 0, 0} '应收金额
    Private taskStatus() As String = {"None", "None", "None", "None"} '收费任务是否启动的“状态”
    Private taskDataRow() As DataRow = {Nothing, Nothing, Nothing, Nothing} '收费任务DataRow
    Private hasInsertProjectDocument() As Boolean = {False, False, False, False} '是否已经插入收据
    Private hasCommit() As Boolean = {False, False, False, False} '是否提交任务
    ...
    Private Sub SaveHandler(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            ElseIf cboType.SelectedValue = "004" Then '融资顾问费
                If Not hasInsertProjectDocument(cboType.SelectedIndex) Then '尚未插入收据
    ...
    Private Function InsertToWorkLog() As Boolean
        ...
        dr("project_code") = ProjectCode
        dr("task_name") = "收取" & CType(cboType.SelectedItem, DataRowView)("item_name").ToString
