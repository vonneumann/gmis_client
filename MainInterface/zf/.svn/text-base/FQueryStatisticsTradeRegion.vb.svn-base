...
#Region " Windows 窗体设计器生成的代码 "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		...
		Me.DataGridTextBoxColumn1.HeaderText = "区域名称"
		Me.DataGridTextBoxColumn1.MappingName = "DistrictName"
...
#End Region
	...
	Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
		...
		Try
			...
			If Not grdTable.DataSource Is Nothing Then
				...
				CType(dataSource, DataTable).TableName = "TQueryStatisticsRegion"
				dataSource = grdTable.DataSource
			End If

			reportViewerForm.ShowDialog(Application.StartupPath + "\Reports\QueryStatisticsTradeRegion.rpt", dataSource, "担保业务区域统计", Me)
		Finally
	...
	Public Overloads Sub Refresh()
		Try
			...
			Dim rsResult As DataSet = gWs.GetQueryStatisticsRegionInfo(dtpDateFrom.Value, dtpDateTo.Value)

			grdTable.SetDataBinding(rsResult, "Table")
			Me.Text = "担保业务区域统计(" + rsResult.Tables("Table").Rows.Count.ToString + ")"
		Finally
			Me.Cursor = Cursors.Default
		End Try
	End Sub
	...
	Private Sub FQueryStatisticsTradeRegion_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
