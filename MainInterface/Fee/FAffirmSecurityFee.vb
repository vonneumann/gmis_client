...
Public Class FAffirmSecurityFee
...
#Region " Windows 窗体设计器生成的代码 "
    ...
    Friend WithEvents txtSecurityRate As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FAffirmSecurityFee))
        ...
        'gpxMeeting
        '
        Me.gpxMeeting.Controls.AddRange(New System.Windows.Forms.Control() {Me.ckxPartnerAffirm, Me.Label7, Me.txtRebetType, Me.txtBaoHanType, Me.Label38, Me.Label39, Me.txtLoanForm, Me.Label13, Me.txtEachReturnFee, Me.Label12, Me.txtRefundType, Me.Label11, Me.txtTerm, Me.Label10, Me.Label9, Me.txtStandard, Me.Label8, Me.txtSum, Me.lblSum, Me.txtServiceType, Me.Label4, Me.txtConclusion, Me.Label3, Me.txtFee, Me.Label1})
        ...
        Me.Label39.Size = New System.Drawing.Size(91, 14)
        ...
        'txtSecurityRate
        '
        Me.txtSecurityRate.Anchor = System.Windows.Forms.AnchorStyles.Bottom
        Me.txtSecurityRate.BackColor = System.Drawing.Color.Gainsboro
        Me.txtSecurityRate.Location = New System.Drawing.Point(112, 453)
        Me.txtSecurityRate.Name = "txtSecurityRate"
        Me.txtSecurityRate.ReadOnly = True
        Me.txtSecurityRate.Size = New System.Drawing.Size(40, 21)
        Me.txtSecurityRate.TabIndex = 85
        ...
        Me.Label15.Text = "保 证 金 比 例"
        '
        'txtSecurityFee
        '
        Me.txtSecurityFee.Anchor = System.Windows.Forms.AnchorStyles.Bottom
        Me.txtSecurityFee.Location = New System.Drawing.Point(312, 453)
        Me.txtSecurityFee.MaxLength = 14
        Me.txtSecurityFee.Name = "txtSecurityFee"
        Me.txtSecurityFee.Size = New System.Drawing.Size(72, 21)
        Me.txtSecurityFee.TabIndex = 0
        ...
        'gpxApplyInfo
        '
        Me.gpxApplyInfo.Controls.AddRange(New System.Windows.Forms.Control() {Me.txtApplyResuiseType, Me.Label26, Me.txtApplyBaoHanType, Me.Label25, Me.txtApplySubBank, Me.Label24, Me.txtApplyBank, Me.Label23, Me.txtApplyTerm, Me.Label22, Me.txtApplySum, Me.Label17})
        ...
        'GroupBox1
        '
        Me.GroupBox1.Controls.AddRange(New System.Windows.Forms.Control() {Me.txtSigBank, Me.Label20, Me.Label18, Me.txtSigSubBank, Me.Label21, Me.txtRunMode, Me.txtEndDate, Me.Label19, Me.Label14, Me.txtRemailSum})
        ...
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.GroupBox1, Me.btnRecord, Me.Label2, Me.Label5, Me.Label6, Me.btnExit, Me.gpxBaoHan, Me.txtSecurityFee, Me.btnCommit, Me.gpxMeeting, Me.txtCorName, Me.txtProjectCode, Me.Label15, Me.txtSecurityRate, Me.Label16})
        Me.MaximizeBox = False
        Me.MinimizeBox = False
        Me.Name = "FAffirmSecurityFee"
        Me.Text = "确认保证金收费标准"
...
#End Region
    ...
    Private Sub FAffirmSecurityFee_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            txtSecurityFee.DataBindings.Add("Text", dsAccount, "project_account_detail.payout")
            ...
            If txtServiceType.Text <> String.Empty Then
                ...
                End If
                txtSecurityRate.DataBindings.Add("Text", dsTrial, "conference_trial.security_rate")
                '有开过会议则不需要显示申请信息
            ...
            Else '该项目没有上过会，有可能是保函品种，因此去project查看运作方式
                ...
                If Not IsDBNull(dsProject.Tables(0).Rows(0)("security_rate")) Then
                    txtSecurityRate.Text = Format(dsProject.Tables(0).Rows(0)("security_rate"), "n")
                End If
            ...
            txtFee.Text = (sum * 100 * CDbl(IIf(txtSecurityRate.Text = String.Empty, 0, txtSecurityRate.Text))).ToString("n")
            txtSecurityFee.Text = txtFee.Text

            AddHandler txtSecurityFee.Enter, AddressOf Money_Enter
            AddHandler txtSecurityFee.KeyPress, AddressOf Money_KeyPress
    ...
    Private Sub txt_Leave(ByVal sender As Object, ByVal e As EventArgs) Handles txtSecurityFee.Leave
        Money.Money_Leave(sender, e)
        If txtSecurityFee.Text <> String.Empty Then
            If CDbl(txtSecurityFee.Text) > MaxFee Then
    ...
    Private Function IsInfoEffective() As Boolean
        Try
            If txtSecurityFee.Text.Trim = "" Then
                Return False
            End If
        Catch
            Return False
    ...
    Private Sub btnCommit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCommit.Click
        ...
        If dsAccount.Tables(0).Rows.Count > 0 Then
            dsAccount.Tables(0).Rows(0)("payout") = IIf(txtSecurityFee.Text <> String.Empty, txtSecurityFee.Text, DBNull.Value)
        ElseIf CDbl(txtSecurityFee.Text) > 0 Then
            ...
            With dr
                ...
                .Item("item_type") = "34"
                .Item("item_code") = "009"
                .Item("payout") = IIf(txtSecurityFee.Text <> String.Empty, txtSecurityFee.Text, DBNull.Value)
