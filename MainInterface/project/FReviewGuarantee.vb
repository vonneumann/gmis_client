...
#Region " Windows 窗体设计器生成的代码 "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FReviewGuarantee))
...
#End Region
    ...
    Private Sub FClaimTool_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If dsTempProject.Tables(0).Rows.Count = 0 Then
            MsgBox("无项目列表!", MsgBoxStyle.Information, "复评反担保措施")
    ...
    Private Sub btnEntery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEntery.Click
        ...
        response = MsgBox("是否确定要启动复评反担保措施?", MsgBoxStyle.YesNo, "复评反担保措施")

        '调用cancelProcess方法取消所选项目的工作流
        If response = MsgBoxResult.Yes Then

            strErr = gWs.CreateProcess("复评反担保措施", Trim(tmpProjectID), UserName, String.Empty)
            If strErr = "1" Then
                MsgBox("启动复评反担保措施成功!", MsgBoxStyle.Information, "复评反担保措施")
            ...
            Else
                MsgBox("启动复评反担保措施失败:" & strErr, MsgBoxStyle.Critical, "复评反担保措施")
            End If
        Else
            Exit Sub
        End If
